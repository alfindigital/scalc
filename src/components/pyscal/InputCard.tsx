...
export function InputCard({
  mode, bids, baseLot, setBaseLot, targetTicks, setTargetTicks,
  targetProfit, setTargetProfit, existingAvg, setExistingAvg,
  existingLot, setExistingLot, setBidAt, bidAwalRef,
}) {
  return (
    <div className="card">
      {mode === 'position' && (
      ...
      <div className="ig">
        <div>
          <div className="il il-wrap">{mode === 'position' ? 'Bid Awal (beli baru)' : 'Bid Awal'}</div>
