        ...
        <div className="modal-body info-body">
          ...
          <section className="info-sec">
            ...
            <ol className="info-ol">
              ...
              <li>Tambah <strong>papan bid</strong> berikutnya — harga turun berlapis untuk averaging-down.
                <span className="ob-kbd info-kbd">{shortcutToString(shortcuts.addPapan)}</span>
              </li>
              <li>PYSCAL menghitung <strong>average price</strong>, total lot, modal terpakai, dan target jual otomatis.</li>
              <li>Simpan hasil ke <strong>History</strong>, atau simpan skema ke <strong>Preset</strong> per ticker lewat Settings.
